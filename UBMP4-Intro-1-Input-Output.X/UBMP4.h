...
#define SW1_INTERRUPT_ENABLE IOCANbits.IOCAN3 // S1 interrupt enable on negative edge signal
#define SW1_INTERRUPT_FLAG IOCAFbits.IOCAF3   // S1 interrupt trigger flag
